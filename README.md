...
For fully working examples take a look at our [examples directory](https://github.com/datocms/datocms-listen/tree/master/examples).

Live demo: [https://datocms-listen-example.netlify.com/](https://datocms-listen-example.netlify.com/)
...
1. Import `Image` from `datocms-listen` and use it in place of the regular `<img />` tag
...
For a fully working example take a look at our [examples directory](https://github.com/datocms/datocms-listen/tree/master/examples).

```js
import React from "react";
import { Image } from "datocms-listen";
...
For a working example take a look at our [examples directory](https://github.com/datocms/datocms-listen/tree/master/examples).

```js
import React from "react";
import { renderMetaTags } from "datocms-listen";
